...
export const inviteFriend = asyncHandler(async (req, res) => {
    ...
    const targetUser = await UserModel.findOne({ email: receiverEmailAddress });
...
export const acceptInvitation = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const sender = await UserModel.findById(deletedInvitation.senderId);
        const receiver = await UserModel.findById(req.user.userId);
